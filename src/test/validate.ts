...
// ────────────────────────────────────────────────────────────
// Test 13: Compliance Report – New Workload Types
// ────────────────────────────────────────────────────────────
console.log('\n═══ Test 13: Compliance Report – New Workload Types ═══');
...
// ────────────────────────────────────────────────────────────
// Test 14: Resource Type Coverage
// ────────────────────────────────────────────────────────────
console.log('\n═══ Test 14: Resource Type Mapping Coverage ═══');
...
assert(readme.includes('8 DR artifacts'), 'README says 8 artifacts (not 7)');
